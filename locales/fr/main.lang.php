...
L10n::$locales['List tags as hastags'] = 'Mentionner les tags comme mots-dièse';
L10n::$locales['Tags conversion mode:'] = 'Mode de conversion des mots-clés :';
L10n::$locales['List the names of the categories as hashtags'] = 'Mentionner les noms de catégorie comme mots-dièse';
L10n::$locales['It will also add the names of the parent categories'] = 'Mentionnera également les noms des catégories parentes';
L10n::$locales['Category names conversion mode:'] = 'Mode de conversion des noms de catégories :';
